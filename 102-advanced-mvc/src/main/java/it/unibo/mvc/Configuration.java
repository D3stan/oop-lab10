...
public final class Configuration {
    ...
    public static class Builder {
        ...
        private boolean consumed = false; // NOPMD needed for easier implementation

        /**
         * @param min the minimum value
         * @return this builder, for method chaining
         */
        public Builder setMin(final int min) { // NOPMD builder, for method chaining
            this.min = min;
            return this;
        }
         ...
         * @return this builder, for method chaining
         */
        public Builder setMax(final int max) { // NOPMD builder, for method chaining
            this.max = max;
            return this;
        }
         ...
         * @return this builder, for method chaining
         */
        public Builder setAttempts(final int attempts) { // NOPMD builder, for method chaining
            this.attempts = attempts;
            return this;
        }
